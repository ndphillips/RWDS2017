...
1. Many decision domains call for simple, efficient algorithms that people can quickly understand and use.

2. Fast-and-frugal trees are ideal candidates for these domains.

3. FFTrees makes it easy for people to create, customise, and visualise them.
