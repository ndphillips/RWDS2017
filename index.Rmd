...
## Result
<font size = 5>Far fewer false-alarms (same accuracy as HDPI)<font>
<br4>
...
<font size = 5>- Simple models can be surprisingly effective, for both small and large datasets.</font>
<br3>
<font size = 5>- It is easy to be seduced by complex models that can fit any dataset</font>
<br3>
<font size = 5>- People are are more likely to use decision tools that provide insight in addition to prediction</font>
<br3>
