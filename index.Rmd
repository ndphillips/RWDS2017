...
# How can one make good decisions based on complex, noisy, limited information?
...
### Goal
<br3>
<font size = 5>Create a <font color = "blue">simple tool</font> that allows anyone to create and <font color = "blue">customise</font>FFTs with minimal programming</font>
<br4>
...
<br3>
<b>Data</b><br>
146 children from the Great Ormond Street Hospitcal in London suspected of having either *neurogenic* or *myopathic* disorders
<br3>
<b>Result</b><br>
...
<h3>How well can a simple FFT actually predict data relative to a complex algorithm?</h3>
...
<font size = 5>Simple models can be surprisingly effective.</font>
<br4>
...
<br4>
<font size = 5>It can be worthwhile to trade a small amount of accuracy for a lot of insight.</font>
